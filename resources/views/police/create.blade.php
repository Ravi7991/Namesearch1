...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Create New Police Record</h1>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('incident_date') is-invalid @enderror" id="incident_date" name="incident_date" value="{{ old('incident_date') }}">
                            @error('incident_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('incident_location') is-invalid @enderror" id="incident_location" name="incident_location" value="{{ old('incident_location') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('incident_details') is-invalid @enderror" id="incident_details" name="incident_details" rows="3">{{ old('incident_details') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="phonetic_first_name" name="phonetic_codes[first_name]" value="{{ old('phonetic_codes.first_name') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="phonetic_middle_name" name="phonetic_codes[middle_name]" value="{{ old('phonetic_codes.middle_name') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="phonetic_last_name" name="phonetic_codes[last_name]" value="{{ old('phonetic_codes.last_name') }}">
